    ...
    Joi.object({
        ...
        nhomSanPhamId:
            Joi.number()
                ...
                .messages({
                    "number.base":
                        "Nhóm sản phẩm phải là số.",

                    "number.integer":
                        "Nhóm sản phẩm phải là số nguyên.",

                    "number.positive":
                        "Nhóm sản phẩm không hợp lệ.",
        ...
        donViTinhId:
            Joi.number()
                ...
                .messages({
                    "number.base":
                        "Đơn vị tính phải là số.",

                    "number.integer":
                        "Đơn vị tính phải là số nguyên.",
        ...
        choPhepDat:
            Joi.boolean()
                ...
                .messages({
                    "boolean.base":
                        "Cho phép đặt phải là true hoặc false."
                }),
        ...
        laSanPhamMoi:
            Joi.boolean()
                ...
                .messages({
                    "boolean.base":
                        "Sản phẩm mới phải là true hoặc false."
                }),
        ...
        laSanPhamNoiBat:
            Joi.boolean()
                ...
                .messages({
                    "boolean.base":
                        "Sản phẩm nổi bật phải là true hoặc false."
                }),
        ...
        thoiGianChuanBiPhut:
            Joi.number()
                ...
                .messages({
                    "number.base":
                        "Thời gian chuẩn bị phải là số.",

                    "number.integer":
                        "Thời gian chuẩn bị phải là số nguyên.",

                    "number.min":
                        "Thời gian chuẩn bị không được nhỏ hơn 0."
                }),
