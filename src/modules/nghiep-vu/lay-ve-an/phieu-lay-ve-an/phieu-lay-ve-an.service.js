...
class PhieuLayVeAnService {
    parseId(id) {
        ...
        if (
            !Number.isInteger(phieuLayVeAnId) ||
            phieuLayVeAnId <= 0
        ) {
            throw new ApiError(
                400,
    ...
    async getGiaVePreview(
        ...
        const donGia = await this.getDonGia(
            thucDonNgayId,
            doiTuongLayVe
        );
    ...
    async getChiTiet(id) {
        ...
        const phieu = await phieuLayVeAnRepository
            .getChiTiet(phieuLayVeAnId);
    ...
    async validateThucDonNgay(id) {
        const thucDonNgay = await phieuLayVeAnRepository
            .getThucDonNgayById(id);
    ...
    async validateNguoiLayVe(data) {
        ...
        if (
            ...
            const nhanVien = await phieuLayVeAnRepository
                .getNhanVienById(
                    data.nhanVienId
                );
        ...
        return {
            ...
            ngaySinhNguoiLayVe:
                ...
                null,
            gioiTinhNguoiLayVe:
                data.gioiTinhNguoiLayVe !== undefined &&
                data.gioiTinhNguoiLayVe !== null
                    ? Number(data.gioiTinhNguoiLayVe)
                    : null,
            soDienThoaiNguoiLayVe:
                data.soDienThoaiNguoiLayVe?.trim() ||
                null,
            diaChiNguoiLayVe:
                data.diaChiNguoiLayVe?.trim() ||
                null,
            donViNguoiLayVe:
                data.donViNguoiLayVe?.trim() ||
                null,
            khachLauDai:
                data.khachLauDai !== undefined
                    ? data.khachLauDai
                    : false
        };
    }
    ...
    async getDonGia(
        ...
        const giaVe = await phieuLayVeAnRepository
            .getGiaVe(
                thucDonNgayId,
                doiTuongLayVe
            );
    ...
    async taoSoPhieuMoi(db) {
        const quyTacSinhMaVeAn = await cauHinhService
            .getQuyTacSinhMaVeAn();

        const nguCanhSinhMaVeAn = this.taoNguCanhSinhMaVeAn(
            quyTacSinhMaVeAn
        );
    ...
    async create(
        ...
        const taiKhoanId = this.parseNguoiDungId(
            nguoiTaoId
        );
        ...
        await this.validateThucDonNgay(
            Number(data.thucDonNgayId)
        );

        const nguoiLayVe = await this.validateNguoiLayVe(
            data
        );
        ...
        const duLieuTao = {
            ...
            ghiChu:
                ...
                null,
            phuongThucThanhToan:
                data.phuongThucThanhToan !== undefined &&
                data.phuongThucThanhToan !== null
    ...
    async update(
        ...
        const phieu = await this.getChiTiet(
            phieuLayVeAnId
        );
        ...
        const duLieuTam = {
            thucDonNgayId:
                data.thucDonNgayId !== undefined
                    ? Number(data.thucDonNgayId)
                    : Number(phieu.thucDonNgayId),

            doiTuongLayVe:
                data.doiTuongLayVe !== undefined
                    ? Number(data.doiTuongLayVe)
                    : Number(phieu.doiTuongLayVe),

            nhanVienId:
                data.nhanVienId !== undefined
                    ? data.nhanVienId
                    : phieu.nhanVienId,

            hoTenNguoiLayVe:
                data.hoTenNguoiLayVe !== undefined
                    ? data.hoTenNguoiLayVe
                    : phieu.hoTenNguoiLayVe,

            ngaySinhNguoiLayVe:
                data.ngaySinhNguoiLayVe !== undefined
                    ? data.ngaySinhNguoiLayVe
            ...
            soDienThoaiNguoiLayVe:
                data.soDienThoaiNguoiLayVe !== undefined
                    ? data.soDienThoaiNguoiLayVe
                    : phieu.soDienThoaiNguoiLayVe,

            diaChiNguoiLayVe:
                data.diaChiNguoiLayVe !== undefined
                    ? data.diaChiNguoiLayVe
                    : phieu.diaChiNguoiLayVe,

            donViNguoiLayVe:
                data.donViNguoiLayVe !== undefined
        ...
        const soLuong =
            data.soLuong !== undefined
                ? Number(data.soLuong)
                : Number(phieu.soLuong);

        const tienGoc =
            donGia *
            soLuong;

        const tongMienGiam = Number(
            phieu.tongMienGiam
        );

        const thanhTien = Math.max(
            tienGoc -
            tongMienGiam,
            0
        );
        ...
        const duLieuCapNhat = {
            ...
            phuongThucThanhToan:
                phuongThucThanhToan !== null
                    ? Number(phuongThucThanhToan)
                    : null
        };

        const ketQua = await phieuLayVeAnRepository
            .update(
                phieuLayVeAnId,
                duLieuCapNhat
            );
    ...
    async getDuLieuInVe(
        ...
        const taiKhoanInId = this.parseNguoiDungId(
            nguoiInId
        );

        const phieuLayVeAnId = this.parseId(
            id
        );
